...
que estes objeto pode realizar no seu sistema.
...
sua função é contruir o objeto a partir da classe

OBS: Todo elementos em Python que inicia e finaliza com duplo underline __ é chamado de dunder (Double Underline)

OBS: Os métodos/funções dunder em Python são chamados de métodos mágicos

Atenção! Por mais que possamos criar nossa próprias funções utilizando dunder (underline no inicio e no fim)
não é aconselhado. Python possui vários métodos com esta forma de nomenclatura e pode ser que mudemos o comportamento
dessas dunções mágicas internas da linguagem. Então, evite ao máximo. De preferência nunca o faça.

#Métodos são escritos em letras minusculas. Se o nome for composto, o nome terá as palavras separadas por underline
...
user2 = Usuario('Felicity', 'Jone', 'felicityjones@gmail.com', '123124')

print(user1.nome_completo())
print(user2.nome_completo())

nome = input('Informe o nome: ')
sobrenome = input('Infome o sobrenome: ')
...
#Métodos de classe em Python são conhecidos como métodos estáticos em outra linguagens
...
print(user.Usuario__gera_usuario()) #Acesso, de forma ruim
"""
