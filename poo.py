...
- POO pe um paradigma de programação que utiliza de mapeamento
...
- CLasse -> Modelo do objeto do mudno real sendo representado computacionalmente;
- Atributo -> Características do objeto.
- Método -> Comportamento do objeto (funções).
- Contrutuor -> Método especial utilizado para criar os objetos;
